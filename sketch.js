...
function setup() {
	...
	box1=Bodies.rectangle(900,590,20,100,{isStatic:true});
	World.add(world, this.box1);
	box2=Bodies.rectangle(1000,630,200,20,{isStatic:true});
	World.add(world, this.box2);
	box3=Bodies.rectangle(1100,590,20,100,{isStatic:true});
...
function draw() {
  ...
  paper.display();
  imageMode(CENTER);
  image(dustbinImg,900,630,100,100);
 
}

function keyPressed() {
	if(keyCode===UP_ARROW) {
		Matter.Body.applyForce(paper.body,paper.body.position,{x:17,y:-25})
	}
}
